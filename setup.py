...
setup(
    ...
    scripts = ['Workflow_Scripts/hidata4gxp.py','Workflow_Scripts/hi4socet.py','Workflow_Scripts/hinoproj.py','SurfaceFit/surface_fit_pc_align.py','SurfaceFit/gpf_transform.py'],
